...
$title = "Stories • Seek";
$keywords = "Seek, Share and capture world's moments, share, capture, messages,create stories";
...
<div class="page-story" style="background-color:#1b1d20;">
    ...
    <div class="story_container">
        <a href="<?php echo url_for('index') ?>" class="site-logo ui-brand">
            <img src="<?php echo url_for('public/assets/images/logo/insta_white.png'); ?>" alt="Instagram" title="Instagram">
        </a>
