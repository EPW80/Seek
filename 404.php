...
$keywords = "error, 404, document not found, webpage not found, Seek, Share and capture world's moments";
...
<div class="error--container">
    <div class="error-content">
        ...
        <p>The link you followed may be broken, or the page may have been removed.<a href="<?php echo url_for('index'); ?>">Go back</a></p>
